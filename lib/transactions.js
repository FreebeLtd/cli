const { StellarSdk, distributor, server } = require('../config');
const out = require('./output');

const trustAccount = async (receiver, asset) => {
...
const buildPayment = ({ sender, senderAccount, receiver, amount, asset }) => {
...
const transferAssets = async (receiver, asset, amount) => {
